    ...
    return (
        <div>
            <div id="carouselExampleIndicators" className="carousel slide" data-ride="carousel">
                ...
                <h1 className="text-center"><span style={{color:'#002db3'}}> JEE</span> <span >Mains & Advanced Preparation</span> </h1>
            ...
            <div className="text-center mt-5">
                <Button style={{ width: '200px', borderRadius: '10px', marginTop:'30px' }} variant="danger"> Clarify your doubts now!</Button>
            </div>
        </div>
    );
};
